...
<head>
    ...
    <title>Universo Farol | Login</title>
...
<body class="Login">
    ...
    <main>
        ...
        <section class="login_sreen">
            <img src="../assets/matheus.png" alt="Matheus Chibi">
            <img src="../assets/julia.png" alt="Julia Chibi">

            <form class="LoginBox" action="configs/autenticar.php" method="post" name="login">
                <h2>Login <br> Universo Farol</h2>
                ...
                <div class="BlockBox senhaInput">
                    ...
                    <span>Senha:</span>
                    <i id="password_toggle" onclick="setupPasswordToggle('senhaLogin', 'password_toggle')" class="senhaIcon fa fa-eye-slash"></i>
                </div>
