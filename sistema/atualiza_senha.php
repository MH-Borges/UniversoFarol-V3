...
<head>
    ...
    <title>NH inteligencia empresarial | Recupera Senha</title>
    <link rel="icon" href="../../assets/logos/Lg_laranja.png" />
        ...
        <section class="recuperaSenhaBlock">
            ...
            <form class="RecupSenhaBox" method="post">
                ...
                <div class="BlockBox senhaInputNew">
                    ...
                    <i id="password_toggle_again" onclick="passwordToggleNew()" class="senhaIconAgain fa fa-eye-slash"></i>
